...
<!-- Google Tag Manager -->
    ...
    // Информацию о странице конверсии
      _gaq.push(['_addItem',
        ...
        'Teslagood ES',           // артикул / - обязательное поле
        'Registration Teslagood RU',        // Языковая версия сайта
        'Teslagood ES',   // Категория или модификация
        '1.00',          // Вес - обязательное поле
...
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
	...
	<div style="display: block;" id="sumbit-modal" class="modal thanks">
        <h2>Felicidades!</h2>
        <p>En su buzón de correo envió un mensaje para confirmar su suscripción.</p>
    </div>
    <script type="text/javascript">
    	setTimeout(function(){
	  		location.replace("./");
