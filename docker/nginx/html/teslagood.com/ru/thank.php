...
<!-- Google Tag Manager -->
    ...
    // Информацию о странице конверсии
      _gaq.push(['_addItem',
        ...
        'Teslagood RU',           // артикул / - обязательное поле
        'Registration Teslagood RU',        // Языковая версия сайта
        'Teslagood RU',   // Категория или модификация
        '1.00',          // Вес - обязательное поле
...
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
	...
	<div style="display: block;" id="sumbit-modal" class="modal thanks">
        <h2>Поздравляем!</h2>
        <p>Ваши контактные данные были получены. Наши менеджеры свяжутся с вами в ближайшее время.</p>
    </div>
    <script type="text/javascript">
    	setTimeout(function(){
	  		location.replace("./");
